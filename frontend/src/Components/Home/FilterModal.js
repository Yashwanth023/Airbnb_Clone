...
// import "react-input-range/lib/css/index.css"; //importing css for input range styling.
...
//   useEffect(() => {
//     setPriceRange({
//       main: selectedFilters.priceRange?.min || 600,
//       max: selectedFilters.priceRange?.max || 30000,
//     });
//     setPropertyType(selectedFilters.propertyType || "");
//     setRoomType(selectedFilters.room || "");
...
//              <div className="icon-box">
//                {amenitiesOptionss.map((options) => (
//                 <div
//                   key={options.value}
//                 className={"amenitiey-checkbox">
...
//                 />
//                 <span className="materials-label amenitieslabel">
//                   {options.icon}
//                 </span>
