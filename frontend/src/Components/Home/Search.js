...
const Search = () => {
  ...
  return (
    <div className='searchbar'>
        <input className='search' id="search_destination" placeholder='Search destination' type='text' 
        ...
        <input className='search' id="addguest" placeholder='Add guest' type='number' 
