        ...
        <div className="col-10 col-lg-5 updateprofile">
            <form onSubmit={submitHandler}>
                ...
                <div className="form-group">
                    <label htmlFor="password_field">Password Current</label>
                    <input
                    type="password"
                    id="passwordCurrent_field"
                    className="form-control"
                    vallue={passwordCurrent}
                ...
                <div className="form-group">
                    ...
                    className="form-control"
                    vallue={passwordConfirm}
                    onChange={(e) => setPasswordConfirm(e.target.value)}
                    />
                </div> 
                <button type="submit" className="btn-block py-3 password-button"> 
                     Update Password
                </button>
            </form>
        </div>
