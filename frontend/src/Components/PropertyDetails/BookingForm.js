...
//   let disabledDates = [];
//   currentBookings.forEach((dates) => disabledDates.push({start: dates.fromDate, end: dates.toDate}));
...
//               <RangePicker format="YYYY-MM-DD" disabledDates={isDateDisabled} onChange={handleDateChange} />
//             </Space>
//           </div>
...
//               onChange={(e) => {setUserData((prev) => ({...prev,guests: e.target.value}))}} />
//           </div>

//           <div className='name-phoneno'>
//             <label className='payment-labels'>Your Full Name:</label>
//             <br/>
//             <input type='text' className='full-name' placeholder='name' required 
//               onChange={(e) => {setUserData((prev) => ({...prev,name: e.target.value}))}} minLength="3"  
//             />
//             <br/>
//             <label className='payment-labels'>Phone No:</label>
//             <br/>
//             <input type='tel' className='phone-number' placeholder='Phone Number' maxLength="10" required 
//               onChange={(e) => {setUserData((prev) => ({...prev,phoneNo: e.target.value}))}} pattern='[0-9]{10}'
//             />
//           </div>
//         </div>
...
//   let disabledDates = [];
//   currentBookings.forEach((dates) => disabledDates.push({ start: moment(dates.fromDate), end: moment(dates.toDate) }));
...
//         const endDate = date.end.endOf('day');
//         return current.isBefore(moment(), 'day') || (current >= startDate && current <= endDate);
//       });
//     }
//   };
...
//           <div className="date">
//             <Space direction="vertical" size={12}>
//               <RangePicker format="YYYY-MM-DD" disabledDate={isDateDisabled} onChange={handleDateChange} />
//             </Space>
//           </div>
...
const BookingForm = ({
  ...
  const handleDateChange = (value, dateString) => {
    ...
    const calculatedNights = moment(dateString[1], "YYYY-MM-DD").diff(
      moment(dateString[0], "YYYY_MM_DD"),
      "days"
    )
    const calculatedTotalPrice = price * calculatedNights
    handleFilterChange("nights", calculatedNights)
    ...
    <div className='form-container'>
      <form className='payment-form' onSubmit={handleBookPlace}>
        ...
        <div className='payment-field'>
          ...
          <div className='guest'>
            <label className='payment-lables'>Number of Guests</label>
            <br />
            <input
              className='no-of-guest'
              placeholder='Number of Guests'
          ...
          <div className='name-phoneno'>
            <label className='payment-lables'>Your Full Name:</label>
            <br />
            <input
              type='text'
              className='full-name'
            ...
            />
            <br />
            <label className='payment-lables'>Phone Number:</label>
            <br />
            <input
              type='tel'
              className='phone-number'
