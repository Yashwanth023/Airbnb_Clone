            ...
            {propertyName && (<>
                ...
                <div className='middle-container row'>
                    <div className='des-and-amenities col-md-8 col-sm-12 col-12'>
                        ...
                        <p className='property-description'>{description} <br/> <br/>
                          <h3><strong>Max number of Guests : {maximumGuest} </strong></h3> 
                        </p> 
                        <hr />
                    ...
                    <BookingForm propertyId={id} price={price} propertyName={propertyName} 
                        address={address} maximumGuest={maximumGuest} currentBookings={currentBookings}
                    />
                    </div>
                </div>
                <hr/>
                <div className='property-map'>
                    <div className='map-image-exinfo-container'>
                        <div className='map-image-conatiner col-md-6 col-sm-12 col-12'>
